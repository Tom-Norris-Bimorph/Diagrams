  ...
  /*  public class DiagramPointLabel : DiagramObject
    {
        ...
        {
            var diagramLabel = new DiagramPointLabel();
            ...
            diagramLabel.m_Mask = DiagramHatch.Create(new Circle(new Plane(new Point3d(leaderLocation.X, leaderLocation.Y, 0), Plane.WorldXY.ZAxis), textSize).ToNurbsCurve(), maskColour, frameColor, frameLineWeight);
        ...
        {
            var bb = new BoundingBox(new Point3d[] { Diagram.ConvertPoint(m_PointLocation) });
